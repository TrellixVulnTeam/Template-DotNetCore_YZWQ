...
}(this, function (exports, common, core, platformBrowser, browser, http, platformBrowserDynamic, animations, rxjs, url, compiler, operators,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 'use strict';
...
PlatformState.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: PlatformState, factory: function PlatformState_Factory(t) { return new (t || PlatformState)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: null });
...
ServerPlatformLocation.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ServerPlatformLocation, factory: function ServerPlatformLocation_Factory(t) { return new (t || ServerPlatformLocation)(ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(INITIAL_CONFIG, 8)); }, providedIn: null });
...
ServerEventManagerPlugin.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ServerEventManagerPlugin, factory: function ServerEventManagerPlugin_Factory(t) { return new (t || ServerEventManagerPlugin)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: null });
...
ServerRendererFactory2.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ServerRendererFactory2, factory: function ServerRendererFactory2_Factory(t) { return new (t || ServerRendererFactory2)(ɵngcc0.ɵɵinject(platformBrowser.EventManager), ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(platformBrowser.ɵSharedStylesHost)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ServerRendererFactory2, [{
        type: Injectable
    }], function () { return [{ type: platformBrowser.EventManager }, { type: core.NgZone }, { type: Object, decorators: [{
                type: Inject,
                args: [common.DOCUMENT]
            }] }, { type: platformBrowser.ɵSharedStylesHost }]; }, { eventManager: [], ngZone: [], document: [], sharedStylesHost: [], rendererByCompId: [], schema: [], defaultRenderer: [], createRenderer: [], begin: [], end: [] });
...
ServerStylesHost.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: ServerStylesHost, factory: function ServerStylesHost_Factory(t) { return new (t || ServerStylesHost)(ɵngcc0.ɵɵinject(common.DOCUMENT), ɵngcc0.ɵɵinject(platformBrowser.ɵTRANSITION_ID, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ServerStylesHost, [{
        type: Injectable
    }], function () { return [{ type: Object, decorators: [{
                type: Inject,
                args: [common.DOCUMENT]
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ServerModule, { imports: [ɵngcc1.HttpClientModule, ɵngcc2.NoopAnimationsModule], exports: [ɵngcc3.BrowserModule] });
...
ServerModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ServerModule_Factory(t) { return new (t || ServerModule)(); }, providers: [
        ...
        { provide: core.Testability, useValue: null },
        { provide: common.ViewportScroller, useClass: common.ɵNullViewportScroller },
    ], imports: [[http.HttpClientModule, animations.NoopAnimationsModule], ɵngcc3.BrowserModule] });
        return ServerModule;
    }());
